...
"""
        ...
        self.assertEqual(
            ...
            (
                ...
                "<i>more</i> items</li></ul><ol><li>This is an <code>ordered"
                "</code> list</li><li>with items</li><li>and more items</li>"
                "</ol></div>"
            ),
        )
...
"""
        ...
        self.assertEqual(
            html,
            (
                "<div><h1>this is an h1</h1><p>this is paragraph text</p><h2>"
                "this is an h2</h2></div>"
            ),
        )
...
"""
        ...
        self.assertEqual(
            html,
            (
                "<div><blockquote>This is a blockquote block</blockquote><p>"
                "this is paragraph text</p></div>"
            ),
        )
